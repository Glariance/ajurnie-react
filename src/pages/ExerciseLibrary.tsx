...
const mockExercises = [
  ...
  },
  {
    ...
    image_url:
      "https://cdn.pixabay.com/photo/2022/05/16/14/47/athlete-7200532_1280.jpg",
    recommended_sets: "3",
  ...
  },
  {
    ...
    image_url:
      "https://cdn.pixabay.com/photo/2023/08/22/01/35/man-8205251_1280.jpg",
    recommended_sets: "4",
...
export default function ExerciseLibrary() {
  ...
  const handleViewDetails = (exercise: typeof mockExercises) => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredExercises.map((exercise) => (
            <div
              key={exercise.id}
              className="bg-gray-800 rounded-lg overflow-hidden border border-gray-700 hover:border-red-500 transition-colors"
            >
              {exercise.image_url && (
                <img
              ...
              <div className="p-6">
                ...
                <button
                  ...
                  className="w-full bg-red-600 text-white py-2 px-4 rounded-lg font-semibold hover:bg-red-700 transition-colors duration-200"
                >
                  View Details
                </button>
              </div>
